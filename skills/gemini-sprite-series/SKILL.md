...
# Gemini Sprite Series Generator
...
1. **Gather requirements** — Ask the user:
   ...
   - Output directory (optional — default: `~/gemini-creative-images/`)
...
- **`gemini-3-pro-image-preview`** (Nano Banana Pro) — 🐢 slower; use when Nano Banana 2 quality isn't good enough (complex scenes, fine detail, photorealism)
